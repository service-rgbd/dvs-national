...
/** Étapes préalables établissement — obligatoires avant soumission. */
...
/** Contrôles internes DVS — obligatoires avant validation. */
...
export function isDvsValidationComplete(dvsValidation: Record<string, unknown>): boolean {
...
export function mergeChecklist(
  ...
  if (!patch) return current as Record<string, boolean>;
